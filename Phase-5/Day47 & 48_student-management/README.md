...
- **Backend:** Python Flask, Flask-CORS, python-dotenv, Gunicorn
...
- **Deployment:** Render (Flask Web Service), Cloud MySQL (Railway / Aiven)
...
python app.py
```
Backend runs on `http://localhost:5000` (or dynamic production port).
