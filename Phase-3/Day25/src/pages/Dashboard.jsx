        ...
        <div className="dashboard-widgets-grid">
          <div className="widget-card profile-widget">
            ...
            <div className="profile-info-body">
              <h3>Green Valley Plot A</h3>
              <p className="profile-meta"><i className="fa-solid fa-map"></i> Palakkad Agronomic Belt, Kerala</p>
              <div className="profile-tags">
                <span className="tag"><i className="fa-solid fa-mound"></i> Clay-Loam Soil</span>
                <span className="tag"><i className="fa-solid fa-ruler-combined"></i> 4.5 Acres</span>
